...
class CacheDesign(BaseModel):
    ...
    # Declared last: see QueueDesign for why the risky nested-list field
    # is placed after every scalar field.
    cached_items: list[CachedItem] = Field(min_length=1, max_length=6)
